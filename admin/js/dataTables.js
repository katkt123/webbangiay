...
(function( factory ) {
	...
	function _fnMacros ( settings, str, entries )
	{
		...
		return str.
			...
			replace(/_ENTRIES_/g, settings.api.i18n('', '', entries) ).
			replace(/_ENTRIES-MAX_/g, settings.api.i18n('hàng', '', max) ).
			replace(/_ENTRIES-TOTAL_/g, settings.api.i18n('hàng', '', vis) );
	}
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 */
			"sInfo": "Hiển thị từ _START_ đến _END_ trong _TOTAL_ _ENTRIES-TOTAL_ hàng",
			 ...
			 */
			"sInfoEmpty": "Hiển thị từ 0 đến 0 trong 0 _ENTRIES-TOTAL_ hàng",
			 ...
			 */
			"sInfoFiltered": "(Lọc từ _MAX_ hàng _ENTRIES-MAX_)",
			 ...
			 */
			"sLengthMenu": "Hiển thị _MENU_ _ENTRIES_ hàng",
